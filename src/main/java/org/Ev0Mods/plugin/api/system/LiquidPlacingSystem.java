...
public class LiquidPlacingSystem extends EntityTickingSystem<ChunkStore> {
    private ComponentType<EntityStore, FluidComponent> fluidComponentComponentType = null;
    @Nonnull
    ...
    public LiquidPlacingSystem() {
        ...
        this.fluidComponentComponentType = fluidComponentComponentType;
    }
